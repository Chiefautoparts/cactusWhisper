...
module.exports = function (app.io){
	...
	app.post('/login', function(req, res){
		...
		res.setHandle('Access-Control-Allow-Origin', '*');
		res.setHandle('Access-Control-ALlow-Method', "'GET, POST, OPTIONS, PUT, PATCH, DELETE'");
		handle = req.body.handle;
		models.user.findOne({"handle":req.body.handle, "password":req.body.password}, function(eer,doc){
			if(err){
				res.send(err);
			}
			if(doc==null){
